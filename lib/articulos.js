...
export async function getArticulosPorSeccion(seccion, limit = 20) {
  // EmDash no soporta filtro por categoría en el endpoint de listado.
  // El agente guarda el campo "seccion" en data al publicar.
  // Descargamos todos los posts y filtramos por ese campo.
